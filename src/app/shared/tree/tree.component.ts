...
export class TreeComponent implements OnInit {
  ...
  // 使用选择框
  @Input() canChecked = false;

  // 是否单选
  @Input() singleChecked = false;

  // 是否级联选择
  @Input() cascadeChecked = false;

  // 隐藏父选择框
  @Input() hideParentCheckBox = false;
  ...
  getCheckedData(): Array<TreeData> {
    const ckList = new Array<TreeData>();
  ...
  searchTree(searchTxt: string = '') {
    ...
    if ('' !== searchTxt) {
      ...
      const nodeList = new Array<TreeData>();
